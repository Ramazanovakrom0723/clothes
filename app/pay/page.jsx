...
const Index = () => {
  return (
    <div className=' mt-[190px] pb-[200px] bg-[#F2F2F2]'>
      ...
      <div className='px-[150px] flex gap-4'>
        <div className='flex gap-4 pt-[18px] px-[18px] pb-[218px] h-[200px] bg-white rounded-lg'>
          <h2>Оплата и Доставка</h2>
        </div>
        <div className='pt-10 pl-[50px] pr-[80px] w-[967px] pb-[71px] bg-white flex flex-col gap-4'>
          ...
          В  окне, появится «Контактная информация» и «Способы доставки», которые Вам не обходимо заполнить.
          </p>
          <div>
          <p>
